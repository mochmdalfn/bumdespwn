...
<html lang="en">
  <head>
    ...
    <!-- Animate.css -->
    <link href="{{ asset('tampilanadmin/vendors/animate.css/animate.min.css') }}" rel="stylesheet">
          ...
          <section class="login_content">
            <form action="/login" method="POST">
              ...
              <div class="separator">
                ...
                <div>
                  <h1>BUMDes Purwawinangun</h1>
                  <p>©2022 All Rights Reserved. BUMDes Purwawingun</p>
                </div>
              </div>
            </form>
          </section>
