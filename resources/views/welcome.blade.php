...
<head>
  ...
  <!-- Favicons -->
  <link rel="icon" href="{{ asset('tampilanutama/assets/img/favicon.png') }}">
  ...
  <link rel="stylesheet" href="{{ asset('tampilanuutama/assets/vendor/glightbox/css/glightbox.min.css') }}">
...
<body>
  ...
  <script src="{{ asset('tampilanutama/ssets/vendor/glightbox/js/glightbox.min.js') }}"></script>
