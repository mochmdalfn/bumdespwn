    ...
    <div class="">
      ...
      <div class="row">
			<div class="col-md-12 col-sm-12 ">
				...
				<div class="x_content">
				<br />
					<form action="{{ route('admin.mitra.update', $mitra->id) }}" method="POST" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="item form-group">
						    ...
						    <div class="col-md-6 col-sm-6 ">
							    <input type="text" name="pemilik" id="first-name" required="required" class="form-control" value={{ $mitra->pemilik }}>
							</div>
					    </div>
						<div class="item form-group">
							<label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Nama Mitra <span class="required"></span> </label>
							<div class="col-md-6 col-sm-6 ">
								<input type="text" id="last-name" name="nmmitra" required="required" class="form-control" value={{ $mitra->nmmitra }}>
						    </div>
						</div>
                        <div class="item form-group">
                        ...
                        <div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 ">
								<input type="text" id="last-name" name="alamat" required="required" class="form-control" value={{ $mitra->alamat }}>
						    </div>
						</div>
                        <div class="item form-group">
