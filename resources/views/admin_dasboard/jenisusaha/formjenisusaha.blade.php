    ...
    <div class="">
      ...
      <div class="row">
			<div class="col-md-12 col-sm-12 ">
				...
				<div class="x_content">
				<br />
					<form action="{{ route('admin.jenisusaha.store') }}" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                        @csrf
                        @method('POST')
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 ">
								<input type="text" id="last-name" name="penjelasan" required="required" class="form-control">
						    </div>
						</div>
