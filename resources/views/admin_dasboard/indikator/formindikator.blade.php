    ...
    <div class="">
      ...
      <div class="row">
			<div class="col-md-12 col-sm-12 ">
				...
				<div class="x_content">
				<br />
					<form action="{{ route('admin.indikator.store') }}" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                        @csrf
                        @method('POST')
